...
public class MainVerticle extends AbstractVerticle {
  ...
  public void start(Future<Void> future) throws Exception {
    ...
    Integer gameVerticleInstances = config.getInteger("game-verticle-instances", 1); // 6
    Integer trafficVerticleInstances = config.getInteger("traffic-verticle-instances", 1);
    Integer serverVerticleInstances = config.getInteger("server-verticle-instances", 1); // 6
